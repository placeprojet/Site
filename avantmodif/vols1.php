...
<body>
        ...
        <nav class="navv">
            <ul class="nav">
                <li class="nav"><a href="acueil.php">Accueil</a></li>
  ...
  <section class=sectionn>   
	<article class="article">               
         <ul class="tab"><?php $id=$idprojet*10;?> 
           <li><a href="javascript://"class="Projet" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+1;?>').innerHTML;">
               <span >Projet</span></a></li>
           <li><a href="javascript://"class="Description" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+2;?>').innerHTML;">
			   <span>Description</span></a></li>
           ﻿<li><a href="javascript://"class="Environnement" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+3;?>').innerHTML;">
			   <span>Environnement</span></a></li>
           <li><a href="javascript://"class="Profil" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+4;?>').innerHTML;">
			   <span>Profil</span></a></li>
           <li><a href="javascript://"class="Contact" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+5;?>').innerHTML;">
			   <span>Contact</span></a></li>
           <li><a href="javascript://"class="Culture"  onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+6;?>').innerHTML;" >
			   <span>Culture</span></a></li>
           ﻿﻿﻿<li><a href="javascript://"class="Similaires" onclick="document.getElementById('<?php echo $id;?>').innerHTML =document.getElementById('<?php echo $id+7;?>').innerHTML;">
         ...
         <div class="box"  id=<?php echo $id+1;?>>
				<h5><?php echo utf8_encode($tlieu['nomlieu']);?> - <span class="h"> <?php echo utf8_encode($proj['nomprojet']);?> 
					...
					<div class="photoprojet">
				     <a href="projet.php?idprojet=1"> <img class="photoprojet" src="img/<?php echo $proj['photo1'];?>" alt="1 photo" ></a>
				   </div>
				   <div class="info" >
		...
		<div class="boxe" id=<?php echo $id+2;?>>
			      <div class="photoprojet">
				     <a href="projet.php?idprojet=1"> <img class="photolelocal" src="img/<?php echo $proj['photo2'];?>" alt="1 photo" ></a>
				  </div></br>
       ...
       <div class="boxe" id=<?php echo $id+3;?>>
		   <div class="photoprojet">
				     <a href="projet.php?idprojet=1"> <img class="photolelocal" src="img/<?php echo $proj['photo3'];?>" alt="1 photo" ></a>
				  </div>
