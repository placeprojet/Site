  ...
  ;?>></iframe> <br /><br/>                
     ...
     <section class=sectionn>   
	   <article class="article">                                           
				   ...
				   <div class="projetd">
				     <p class="projets">Embauche(s) prévue(s) : <span class="number"><?php echo utf8_encode($proj['embauche']);?>  personnes</span>
				     <p class="projets">Contrat proposé : <span class="number"><?php echo utf8_encode($proj['contrat']);?> </span></p>
				     <p class="projets">Structure juridique prévue : <span class="number"><?php echo utf8_encode($proj['juridique']);?> </span></p>				
		           </div>
		           </div>
			         <hr/>
			        ...
			        <div class="lelocal">
				     ...
				     <p class="lelocals">Département : <span class="number"><?php echo utf8_encode($tdep['nom']);?> </span>
				     ...
				     <p class="lelocals">G.E.S. : <span class="number"><?php echo $tges['ges'];?></span>
			        ...
			        <div class="economique">
				      ...
				      <p class="economiques">Loyer : <span class="number"><?php echo $proj['loyerfonds'];?>&nbsp;€</span>
				    ...
				    <p class="economiques">M.B. : <span class="number"><?php echo $proj['mb'];?>&nbsp;€</span></p>
				     <p class="economiques">Impôt sociétés : <span class="number"><?php echo $proj['impot'];?>&nbsp;€</span>
